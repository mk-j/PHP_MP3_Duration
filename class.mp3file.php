 ...
 * @link https://github.com/mk-j/PHP_MP3_Duration
 * @license https://choosealicense.com/licenses/mit/  The MIT License (MIT)
 */
class MP3File {
  protected $filename;
  ...
  /**
   * Fast Calling Static Function to get the Duration via the Longer Method
   * @param String File Path and file Name to the MP3 file to Test
   * @return Int|Boolean Total Time or False if it can be found.
   */
  public static function getTime($filename){
    ...
    $t = new MP3File($filename);
    return $t->getDuration();
  }

  /**
   * Format time into Hours, Minutes, and Seconds
   * @param String formatDate from the hh:mm:ss format
   ...
   * @return Int Estimated Time Duration
   */
  ...
  /**
   * @param Int The Input Bitrate
   * @param Int File Data Offset
   * @return Int Approx of the Duration of the Media File
   */
